package io.tinyrpc.consumer.yaml.config;

/**
 * 消费者Yaml配置
 */
public class ConsumerYamlConfig {
	...
	public ConsumerYamlConfig() {
	}

	public ConsumerYamlConfig(final String registryAddress, final String registryType, final String loadBalanceType,
